...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("correct", "Record a taxonomy correction for the previous assistant trace", "Session",
               args_hint="<taxonomy>"),
    CommandDef("lessons", "Inspect or retract shadow lessons (local operator only)", "Session",
               cli_only=True, args_hint="[list|inspect <lesson-id>|retract <event-id>]",
               subcommands=("list", "inspect", "retract")),
